...
export class CategoryController {
  ...
  static async create(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const result = await CategoryService.create(data, req.user!.userId);
  ...
  static async update(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const result = await CategoryService.update(req.params.id as string, data, req.user!.userId);
      sendSuccess(res, result);
    } catch (err) { next(err); }
  }
  ...
  static async remove(req: Request, res: Response, next: NextFunction) {
    try {
      await CategoryService.remove(req.params.id as string, req.user!.userId);
